...
class Transaction
{
    ...
    public function count(?int $userId = null): int
    {
        ...
        try {
            ...
            throw new \Exception("Error counting transactions: " . $e->getMessage());
        }
    }
    ...
    public function create(array $data): int
    {
        ...
        try {
            ...
            $stmt->bindParam(':status', $data['status'] ?? 'completed');
    ...
    public function getUserTransactions(int $userId, int $limit = 20): array
    {
        ...
        try {
            ...
            throw new \Exception("Error fetching user transactions: " . $e->getMessage());
        }
    }
    ...
    public function getProductSales(int $productId): array
    {
        ...
        try {
            ...
            throw new \Exception("Error fetching product sales: " . $e->getMessage());
        }
    }
    ...
    public function getSalesStats(string $startDate, string $endDate): array
    {
        ...
        try {
            ...
            throw new \Exception("Error fetching sales statistics: " . $e->getMessage());
        }
    }
     ...
     */
    public function getTopSellingProducts(int $limit = 10, string $period = 'all'): array
    {
        $dateCondition = '';
        if ($period === 'today') {
    ...
    public function processPurchase(int $userId, int $productId, int $quantity): array
    {
        try {
            ...
            // Get product details
            $productQuery = "SELECT * FROM products WHERE id = :id AND is_active = 1 FOR UPDATE";
            ...
            if ($product['quantity_available'] < $quantity) {
                throw new \Exception("Insufficient stock. Available: " . $product['quantity_available']);
            }
            ...
            $updateQuery = "UPDATE products SET quantity_available = :quantity, updated_at = CURRENT_TIMESTAMP WHERE id = :id";
