...
<div class="row mb-4">
    ...
    <div class="col-md-3">
        <div class="card bg-light">
            <div class="card-body text-center">
                <h5 class="text-success"><?= count(array_filter($products, fn($p) => $p['is_active'])) ?></h5>
    ...
    <div class="col-md-3">
        <div class="card bg-light">
            <div class="card-body text-center">
                <h5 class="text-warning"><?= array_sum(array_column($products, 'quantity_available')) ?></h5>
    ...
    <div class="col-md-3">
        <div class="card bg-light">
            <div class="card-body text-center">
                <h5 class="text-info"><?= count(array_filter($products, fn($p) => $p['quantity_available'] < 10)) ?></h5>
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <form method="POST" action="/admin/products/delete" class="d-inline">
                                            ...
                                            <button type="submit" 
                                                    ...
                                                    data-confirm="Are you sure you want to delete '<?= htmlspecialchars($product['name']) ?>'?">
