...
class Product
{
    ...
    {
        $activeCondition = $activeOnly ? "WHERE is_active = 1" : "";
        $query = "SELECT COUNT(id) as total FROM products $activeCondition";
        ...
        try {
            ...
            throw new \Exception(
                "Error counting products: " . $e->getMessage(),
            );
        }
    }
    ...
    {
        $query =
            "UPDATE products SET is_active = 0, updated_at = CURRENT_TIMESTAMP WHERE id = :id";
    ...
    public function hardDelete(int $id): bool
    {
        ...
        try {
            ...
            throw new \Exception(
                "Error hard deleting product: " . $e->getMessage(),
            );
        }
    }
    ...
    public function updateQuantity(int $id, int $newQuantity): bool
    {
        ...
        try {
            ...
            throw new \Exception(
                "Error updating product quantity: " . $e->getMessage(),
            );
        }
    }
